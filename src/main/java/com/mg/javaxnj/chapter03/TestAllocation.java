 ...
 *
 * @author 谢小平 -XX:+UseSerialGC -verbose:gc -Xms20M -Xmx20M -Xmn10M -XX:+PrintGCDetails -XX:SurvivorRatio=8 -XX:+PrintTLAB -XX:-BackgroundCompilation -XX:-DoEscapeAnalysis -Xcomp
 *  * @date 2019/4/26
 */
...
//        byte[]  bytes1,bytes2,bytes3,bytes4;
//        bytes1 = new byte[2 * _1MB];_1MB];
//        bytes2 = new byte[2 *
//        bytes3 = new byte[2 *
//        bytes4 = new byte[4 * _1MB];_1MB];
//    }
}
